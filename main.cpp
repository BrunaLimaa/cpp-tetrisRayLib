...
int main()
{
    ...
    Color bgColor = {60,38,188,255};
    Color textBox = {43,27,137,255};
    ...
    while (WindowShouldClose() == false)
    {
        ...
        if (game.gameOver)
        {
            DrawTextEx(font, "GAME OVER", {330, 470}, 30, 2, RED);
        };
        
        DrawRectangleRounded({320, 55, 170, 60}, 0.3, 6, textBox);
        ...
        DrawRectangleRounded({320, 215, 170, 180}, 0.3, 6, textBox);
        game.Draw();
